...
const valgrindLeakChck = {env: {...process.env, VALGRIND_OPTS: "--quiet --tool=memcheck --leak-check=full --errors-for-leak-kinds=all --undef-value-errors=yes --track-origins=no --show-error-list=yes --keep-debuginfo=no --show-emwarns=yes --demangle=yes --smc-check=none --num-callers=9 --max-threads=9"}}
